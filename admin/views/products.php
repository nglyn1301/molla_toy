<div class="row">
    ...
    <div class="col-lg-3">
        <form action="?controller=products&action=search" method="post">
            <input type="search" class="form-control" name="timkiem" id="timkiem" placeholder="Tìm kiếm tên sản phẩm.."
                required>
        </form>
    </div>
    <div class="col-lg-3">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-danger"
                    href="?controller=products&action=delete&id=<?php echo $product['product']['id']; ?>" onclick="return confirmDelete()">Xóa</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
