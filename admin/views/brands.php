...
<div class="mb-4">
    <div class="row">
        ...
        <div class="col-lg-6">
            <form action="?controller=brands&action=search" method="post">
                <input type="search" class="form-control" name="timkiem" id="timkiem"
                    placeholder="Tìm kiếm tên nhãn hiệu.." required>
            </form>
        </div>
    </div>
</div>
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <img width="100px" src="../assets/images/brands/<?php echo $brand['imageurl']; ?>" alt="">
            </td>
            <td class="flex">
        ...
        <div class="modal fade" id="editModal<?php echo $brand['id']; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="?controller=brands&action=updatebrand" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="editDescription" name="editDescription"
                                    required><?php echo $brand['description']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="addImage">Hình ảnh:</label>
                                <img width="100px" src="../assets/images/brands/<?php echo $brand['imageurl']; ?>"
                                    alt="">
