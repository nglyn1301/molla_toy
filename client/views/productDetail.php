                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                ...
                                <figure class="product-main-image">
                                    <img id="product-zoom" src="uploads/<?=$product['images'][0]?>" alt="product image">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    ...
                                    <a class="product-gallery-item" href="#">
                                        <img class="image" src="uploads/<?php echo $image; ?>" height="200"
                                            alt="product side">
                        ...
                        <div class="product-details">
                            ...
                            <form action="?controller=cart" method="post">
                                ...
                                <div class="product-details-action">
                                    <input type="submit" class="btn-product btn-cart" name="add"
                                        value="Thêm vào giỏ hàng">

                                    <div class="details-action-wrapper">
                                        <a href="#" class="btn-product btn-wishlist" title="Wishlist"><span>Yêu
                                                thích</span></a>
                            ...
                            <div class="container w-100">
                                <div class="list-group">
                                    <div class="list-group-item">
                                        <h5 class="mb-1">Độ tuổi</h5>
                                        <p class="mb-0">
                                            <?php echo $configuration["agerange"] ?>
                                        </p>
                                    </div>
                                    <div class="list-group-item">
                                        <h5 class="mb-1">Trọng lượng</h5>
                                        <p class="mb-0">
                                            <?php echo $configuration["weight"] ?>
                                        </p>
                                    </div>
                                    <div class="list-group-item">
                                        <h5 class="mb-1">Chất liệu</h5>
                                        <p class="mb-0">
                                            <?php echo $configuration["material"] ?>
                                        </p>
                                    </div>
                                    <div class="list-group-item">
                                        <h5 class="mb-1">Nơi sản xuất</h5>
                                        <p class="mb-0">
                                            <?php echo $configuration["origin"] ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
